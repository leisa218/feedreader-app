...
$(function() {
    ...
    */
    ...
    describe('New Feed Selection', function() {
        //  define two variables to store the feed content for comparison
        var feed,
            newFeed;
        ...
        it('that content actualy changes', function() {
